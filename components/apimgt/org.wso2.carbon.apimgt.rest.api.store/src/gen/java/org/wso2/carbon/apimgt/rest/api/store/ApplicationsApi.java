...
public class ApplicationsApi  {
   ...
   private final ApplicationsApiService delegate = ApplicationsApiServiceFactory.getApplicationsApi();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get a list of applications", notes = "Get a list of applications", response = ApplicationListDTO.class)
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Create a new application", notes = "Create a new application", response = ApplicationDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Generate keys for application", notes = "This operation can be used to generate client Id and client secret for an application", response = ApplicationKeyDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nKeys are generated."),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Get application details", notes = "Get application details", response = ApplicationDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Update application details", notes = "Update application details", response = ApplicationDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nApplication updated."),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Remove an application", notes = "Remove an application", response = Void.class)
    @io.swagger.annotations.ApiResponses(value = { 
